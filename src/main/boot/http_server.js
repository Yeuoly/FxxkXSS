...
import { source_domain, proxy_domain_len, source_port_local, isSSL, proxy_port_local, sslCert, sslKey, ws_port_remote, proxy_domain } from '../conf';
import { btoa, cryptoPayload, baseXSSPayload, hookRequestPayload, cookiePayload } from '../utils';
import { proxyRequest } from './xss_core';
